...
public class RecordPatientDetailsWizardActivity extends SupportingLifeBaseActivity implements PageFragmentCallbacks, ReviewFragment.Callbacks, ModelCallbacks {
    ...
    private AbstractWizardModel mWizardModel = new SupportingLifeBreadcrumbWizardModel(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_patient_details_wizard);
