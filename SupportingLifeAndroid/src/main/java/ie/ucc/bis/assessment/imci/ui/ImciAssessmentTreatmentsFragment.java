...
import ie.ucc.bis.assessment.imci.model.TreatmentAdapter;
...
/**
 * Class: ImciAssessmentTreatmentsFragment
 * 
...
public class ImciAssessmentTreatmentsFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	  View myFragmentView = inflater.inflate(R.layout.fragment_imci_assessment_results_treatment_tab, container, false);
