...
public class CcmAssessmentModel extends AbstractModel {
	...
	public static final String CCM_INITIAL_ASK_ASSESSMENT_PAGE_TITLE = "Look and Ask Assessment (1)";
	public static final String CCM_SECONDARY_ASK_ASSESSMENT_PAGE_TITLE = "Look and Ask Assessment (2)";
