...
import ie.ucc.bis.assessment.imci.model.ClassificationAdapter;
...
public class ImciAssessmentClassificationsFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	  View myFragmentView = inflater.inflate(R.layout.fragment_imci_assessment_results_classification_tab, container, false);
