...
public class FeverAssessmentPage extends AbstractPage {
    ...
    public void getReviewItems(ArrayList<ReviewItem> reviewItems) {
    	...
    	// a 'No Malaria Risk' response would indicate that the negative symptom criteria would apply
    	reviewItems.add(new RadioToggleReviewItem(reviewItemLabel, reviewItemValue, reviewItemSymptomId, getKey(), -1,
    			resources.getString(R.string.fever_assessment_radio_malaria_risk_no)));
    	...
    	reviewItems.add(new TextReviewItem(reviewItemLabel, getPageData().getString(DURATION_DATA_KEY), reviewItemSymptomId, getKey(), -1));
