...
import ie.ucc.bis.supportinglife.training.ui.TrainingFragment;
...
public class VideoViewerActivity  extends SupportingLifeBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int videoResourceId = getResources().getIdentifier(videoFilename, "raw", "ie.ucc.bis.supportinglife");
